...
def formatTimesToString(startEndSeconds, separator):
    startEndParts = startEndSeconds.split(";")
    startSeconds = int(float(startEndParts[0]))
    endSeconds = int(float(startEndParts[1]))
    start = str(datetime.timedelta(seconds=startSeconds))
    end = str(datetime.timedelta(seconds=endSeconds))
